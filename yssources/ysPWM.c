...
void InitPWM()
{
	...
	/* ======== 4th Leg ======== */
	// ----------------EPwm3---------------------
	EPwm3Regs.TBPHS.half.TBPHS = MPCperiod - 400;  // 时基周期寄存器
	...
	/* ======== 1-3 Leg ======== */
	// ----------------EPwm4---------------------
	EPwm4Regs.TBPHS.half.TBPHS = MPCperiod - 400;  // 时基周期寄存器
	...
	EPwm4Regs.CMPA.half.CMPA = 0; // 周期为7kHz， duty_cycle = 0.5
	EPwm4Regs.CMPB = 0;
	...
	// ----------------EPwm5---------------------
	EPwm5Regs.TBPHS.half.TBPHS = MPCperiod - 400;  // 时基周期寄存器
	...
	// ----------------EPwm6---------------------
	EPwm6Regs.TBPHS.half.TBPHS = MPCperiod - 400;  // 时基周期寄存器
